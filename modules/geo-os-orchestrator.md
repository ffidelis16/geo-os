...
|---|---|---|---|---|
| `audit-existing-content` | avaliar conteúdo existente | `extractability-audit` → `trust-signal-audit` → `geo-scorecard` | `geo-diagnosis` quando o escopo for domínio, site ou ecossistema; `competitor-analysis` quando houver páginas comparáveis e objetivo competitivo; remover auditoria já fornecida | `extractability-audit-template.md`, `trust-signal-audit-template.md`, `geo-scorecard-template.md`, `audit-report.md`, `competitor-gap-analysis.csv` |
...
Os dez fluxos canônicos podem acionar skills adicionais por expansão condicional, sem criar novos fluxos. `geo-diagnosis` é a expansão para domínio, site ou ecossistema; `competitor-analysis` é a expansão para páginas comparáveis com objetivo competitivo declarado.
...
- Reduzir “não reescrever conteúdo final” a uma nota e, ainda assim, entregar texto final.
